...
if __name__ == '__main__':
    ...
    ''' compute dp noise '''
    arg_setup.pub_num = 0
    arg_setup.samples_per_group = 1
    arg_setup.self_aug_times = 0
    sigma = arg_setup.sigma = 1 * aa.get_std(q = expected_batchsize / (arg_setup.usable_train_data_samples),
    ...
    num_of_groups = expected_batchsize
